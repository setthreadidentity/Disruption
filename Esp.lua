...
local ESP = {
    ...
    Drawing = {
        ...
        Healthbar = {
            Enabled = true,  
            HealthText = true, Lerp = false, HealthTextRGB = Color3.fromRGB(106, 202, 111),
            Width = 2.5,
            Gradient = true, GradientRGB1 = Color3.fromRGB(0, 200, 50), GradientRGB2 = Color3.fromRGB(0, 200, 50), GradientRGB3 = Color3.fromRGB(0, 200, 50), 
        },
        Boxes = {
            Animate = false,
            RotationSpeed = 300,
            Gradient = false, GradientRGB1 = Color3.fromRGB(255, 165, 0) , GradientRGB2 = Color3.fromRGB(0, 0, 0), 
            GradientFill = true, GradientFillRGB1 = Color3.fromRGB(255, 165, 0), GradientFillRGB2 = Color3.fromRGB(0, 0, 0), 
            Filled = {
                Enabled = false,
                Transparency = 0.75,
                            ...
                            do -- Distance
                                if ESP.Drawing.Distances.Enabled then
                                    ...
                                    elseif ESP.Drawing.Distances.Position == "Text" then
                                        ...
                                        Distance.Visible = false
                                        if ESP.Options.Friendcheck and lplayer:IsFriendsWith(plr.UserId) then
                                            Name.Text = string.format('[<font color="rgb(%d, %d, %d)">Team</font>] %s [%d]', ESP.Options.FriendcheckRGB.R * 255, ESP.Options.FriendcheckRGB.G * 255, ESP.Options.FriendcheckRGB.B * 255, plr.Name, math.floor(Dist))
                                        else
                                            Name.Text = string.format('[<font color="rgb(%d, %d, %d)">Enemy</font>] %s [%d]', 255, 0, 0, plr.Name, math.floor(Dist))
                                        end
                                        Name.Visible = ESP.Drawing.Names.Enabled
                                    end
                                end
